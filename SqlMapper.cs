...
#pragma warning restore IDE0038 // Use pattern matching
        ...
        #region Extensions from Dapper.Contrib
        /// <summary>
        ...
        /// <summary>Inserts an entity into table "T" and returns identity id or number of inserted rows if inserting a list.</summary>
        ...
        /// <summary>Updates entity in table "T", checks if the entity is modified if the entity is tracked by the Get() extension.</summary>
        ...
        /// <summary>Delete entity in table "T"</summary>
        ...
        public static int DeleteByKey<T>(this IDbConnection connection, dynamic id, IDbTransaction transaction = null, int? commandTimeout = null) where T : class
        {
            var type = typeof(T);

            var keyProperties = KeyPropertiesCache(type).ToList();
            keyProperties.AddRange(ExplicitKeyPropertiesCache(type));
            if (keyProperties.Count == 0) throw new ArgumentException("Entity must have at least one [Key] or [ExplicitKey] property");

            var sql = $"DELETE FROM {GetTableName(type)} WHERE {keyProperties[0].Name} = @key";
            var dynParams = new DynamicParameters();
            dynParams.Add("@key", id);
            return connection.Execute(sql, dynParams, transaction, commandTimeout);
        }

        //!━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
        //!━━━━━━━━━━━ helper methods for Dapper.Contrib ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
        static readonly ConcurrentDictionary<RuntimeTypeHandle, IEnumerable<PropertyInfo>> KeyProperties = new ConcurrentDictionary<RuntimeTypeHandle, IEnumerable<PropertyInfo>>();
        static readonly ConcurrentDictionary<RuntimeTypeHandle, IEnumerable<PropertyInfo>> ExplicitKeyProperties = new ConcurrentDictionary<RuntimeTypeHandle, IEnumerable<PropertyInfo>>();
        static readonly ConcurrentDictionary<RuntimeTypeHandle, IEnumerable<PropertyInfo>> TypeProperties = new ConcurrentDictionary<RuntimeTypeHandle, IEnumerable<PropertyInfo>>();
        static readonly ConcurrentDictionary<RuntimeTypeHandle, string> GetQueries = new ConcurrentDictionary<RuntimeTypeHandle, string>();
        ...
        static readonly ConcurrentDictionary<RuntimeTypeHandle, IEnumerable<PropertyInfo>> ComputedProperties = new ConcurrentDictionary<RuntimeTypeHandle, IEnumerable<PropertyInfo>>();

        static bool IsWriteable(PropertyInfo pi)
        {
        ...
        static List<PropertyInfo> TypePropertiesCache(Type type)
        {
        ...
        static List<PropertyInfo> ExplicitKeyPropertiesCache(Type type)
        {
        ...
        static PropertyInfo GetSingleKey<T>(string method)
        {
            var type = typeof(T);
        ...
        static string GetTableName(Type type)
        {
            ...
            //TH: disable TableNameMapper (for a while, maybe it's not needed at all)
        ...
        static readonly Dictionary<string, ISqlAdapter> AdapterDictionary = new Dictionary<string, ISqlAdapter>
        {
        ...
        {
            //TH: reduce unnecessary customization
